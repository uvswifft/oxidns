...
export const enUSWebui = {
  ...
  shell: {
    ...
    editorDisabledInStandardMode:
      "The config editor is unavailable in Standard Mode",
    ...
    switchToStandardMode: "Switch to standard mode",
  ...
  standardShell: {
    ...
    phase3ReadOnly:
      "This page only establishes the information architecture. Editing workflows will arrive in later phases.",
    routingDescription:
      "Routing rules will send selected domains, clients, or query types to a chosen resolution path.",
    routingEmptyTitle: "No routing rules yet",
    routingEmptyDescription:
      "Manual rules and scenario presets will live here. Phase 3 only shows counts from the schema v2 draft.",
    routingRulesMetric: "Routing rules",
    routingScenariosMetric: "Scenarios",
    enabledRulesMetric: "Enabled rules",
    exceptionsDescription:
      "Exceptions handle false positives, temporary allows, skipped filtering, or path overrides.",
    exceptionsEmptyTitle: "No exception rules yet",
    exceptionsEmptyDescription:
      "Allow, block, and skip-filtering policies will live here. Phase 3 does not expose editing controls.",
    exceptionsMetric: "Exception rules",
    devicesDescription:
      "Devices will name clients on the home network and bind device-level paths or filtering policies.",
    devicesEmptyTitle: "No named devices yet",
    devicesEmptyDescription:
      "Device profiles and device-level policies will live here. Phase 3 reserves the route and navigation model.",
  ...
  standardDns: {
    title: "DNS & Upstreams",
    description:
      "Configure Standard Mode listeners, default upstreams, cache, and query logging.",
    saveApply: "Save and apply",
    saveBlocked: "Fix validation issues before saving",
    savingApplying: "Saving and applying",
    listenTitle: "Listeners",
    listenAddress: "Listen address",
    listenProtocols: "Listen protocols",
    udp: "UDP",
    tcp: "TCP",
    ...
    tlsVerify: "Verify certificate",
    dohPath: "DoH path",
    optional: "Optional",
    unsupportedProtocol: "Unsupported in this build",
    unsupportedProtocolDetail: "Requires features: {features}",
    testUpstream: "Test",
    testAllUpstreams: "Test all",
    testRunning: "Testing",
    testSuccess: "Reachable",
    testFailed: "Failed",
    testNotRun: "Not tested yet.",
    testDisabledUpstream: "This upstream is disabled and will be skipped.",
    testAddressRequired: "Enter an address before testing.",
    testProtocolUnsupported: "This build does not support this protocol.",
    testLatency: "{latency} ms",
    testAnswerCount: "{count} answers",
    testGroupSummary:
      "Upstream tests completed: {success} succeeded, {failed} failed, fastest {upstream} ({latency} ms).",
    testGroupNoSuccess:
      "Upstream tests completed: {failed} failed, no reachable upstreams.",
    protocolAuto: "Auto",
    protocolUdp: "UDP",
    protocolTcp: "TCP",
    protocolDot: "DoT",
    ...
    protocolDoq: "DoQ",
    cacheTitle: "Cache",
    cacheUnsupported: "This build does not support cache",
    ...
    validationUpstreamRequired:
      "The default upstream group needs at least one enabled upstream with an address.",
    validationAddressRequired: "Enabled upstreams need an address.",
  ...
  standardFiltering: {
    ...
    subscriptionStatusTitle: "Subscription runtime status",
    subscriptionStatusDescription:
      "Shows the currently applied download, schedule, and rule provider state.",
    subscriptionRuntimeNotApplied:
      "No applied subscription runtime was found. Save and apply Standard Mode filtering first.",
    subscriptionRefreshSuccess: "Subscription refresh completed.",
    subscriptionRefreshFailed: "Subscription refresh failed.",
    subscriptionFile: "Local file",
    subscriptionFileMissing: "File missing",
    subscriptionFileSize: "File size",
    subscriptionFileModified: "Modified",
    subscriptionLastSuccess: "Last success",
    subscriptionLastError: "Last error",
    providerTotalRules: "Total rules",
    providerSupportedRules: "Supported rules",
    providerSkippedRules: "Skipped rules",
    providerExceptionRules: "Exception rules",
    cronNextRun: "Next refresh",
    cronLastSuccess: "Last scheduled success",
  ...
  standardExceptions: {
    title: "Exceptions",
    description:
      "Handle false positives, temporary allows, blocks, skipped filtering, or path overrides.",
    saveApply: "Save and apply",
    savingApplying: "Saving and applying",
    overviewTitle: "Exception overview",
    priorityTitle: "Fixed priority",
    priorityDescription:
      "Exceptions use fixed semantic ordering. Users cannot change the generated execution order.",
    priorityBlock: "Explicit block",
    priorityAllow: "Explicit allow",
    prioritySkipFiltering: "Skip ad filtering",
    priorityPath: "Selected resolution path",
    priorityPrefer: "Dual-stack preference",
    priorityRouting: "Routing rules",
    priorityDefault: "Default resolution path",
    rulesTitle: "Exception rules",
    rulesDescription: "Enabled exceptions run before normal routing rules.",
    rulesEmpty: "No exception rules yet.",
    addRule: "Add exception",
    removeRule: "Remove exception",
    ruleEnabled: "Enabled",
    ruleName: "Name",
    ruleCondition: "Condition",
    ruleAction: "Action",
    ...
    actionAllow: "Allow",
    actionBlock: "Block",
    actionSkipFiltering: "Skip ad filtering",
    actionUsePath: "Use selected path",
    actionUseDefaultPath: "Use default path",
    actionPreferIpv4: "Prefer IPv4",
    actionPreferIpv6: "Prefer IPv6",
    actionDisableLogging: "Disable logging",
    unsupportedCapability: "Unsupported in this build",
    totalCount: "Exception rules",
    enabledCount: "Enabled",
    blockCount: "Block rules",
    validationTitle: "Before saving",
    validationCapabilityRequired:
      "This build lacks sequence, so exceptions cannot be enabled.",
    validationNameRequired: "Enabled exceptions need a name.",
    validationConditionRequired:
      "Enabled exceptions need at least one condition value.",
    validationActionRequired:
      "Enabled exceptions need an existing target path.",
    validationActionUnsupported:
      "This exception action is unavailable in this build or belongs to a later phase.",
    validationConditionUnsupported:
      "This exception condition belongs to a later phase and cannot be saved as runtime config yet.",
    validationMatcherUnsupported:
      "This build lacks the matcher required by this exception condition.",
  },
  standardQueries: {
    title: "Query Log",
    description:
      "Explain why recent DNS queries matched a path, rule, or handling result.",
    refresh: "Refresh",
    recorderUnavailable:
      "This build or current runtime config does not enable query_recorder. Enable Standard Mode query logging, save, and apply to see query records and explanations here.",
    recordsTitle: "Query records",
    loadedRecords: "{count} loaded",
    enrichingRecords: "Enriching explanations",
    qnameFilter: "Domain",
    clientFilter: "Client",
    statusFilter: "Status",
    statusError: "Error",
    ...
    domainColumn: "Domain",
    pathColumn: "Path",
    upstreamColumn: "Upstream group",
    ruleColumn: "Matched rule",
    outcomeColumn: "Result",
    elapsedColumn: "Elapsed",
    loading: "Loading query records...",
    empty: "No query records.",
    unknown: "Unknown",
    readFailed: "Failed to read query records.",
    readDetailFailed: "Failed to read query detail.",
    detailTitle: "Query detail #{id}",
    explanationTitle: "Standard Mode explanation",
    rawOnlyNotice:
      "This record lacks mappable Standard Mode metadata or execution steps. Raw runtime events are still shown for troubleshooting.",
    executionFlowTitle: "Execution flow",
    quickActionsTitle: "Quick actions",
    quickActionsDescription: "Create Standard Mode rules for {domain}.",
    quickActionsUnavailable: "This record has no actionable domain.",
    addBlockRule: "Add to blocklist",
    addAllowRule: "Add to allowlist",
    createRouteRule: "Create domain route",
    actionValidationFailed:
      "Current settings did not pass Standard Mode validation. The quick action was not saved.",
    blockSaved: "{domain} was added to the blocklist and applied.",
    allowSaved: "{domain} was added to the allowlist and applied.",
    routeSaved: "A routing rule for {domain} was created and applied.",
    exceptionRuleLabel: "Exception: {name}",
    routingRuleLabel: "Route: {name}",
    outcomeError: "Error",
    outcomeBlocked: "Blocked",
    outcomeCache: "Cache response",
    outcomeException: "Exception matched",
    outcomeRouting: "Route matched",
    outcomeResolved: "Resolved",
    outcomeNoResponse: "No response",
    filteringStatus: "Filtering",
    filteringBlocked: "Blocked",
    filteringChecked: "Checked",
    filteringSkipped: "Skipped",
    cacheStatus: "Cache",
    cacheChecked: "Checked",
    queryLogStatus: "Log",
    queryLogRecorded: "Recorded",
  },
  standardDevices: {
    title: "Devices",
    description:
      "Discover clients, name devices, and bind device-level paths, filtering, and query logging policies.",
    saveApply: "Save and apply",
    savingApplying: "Saving and applying",
    addDevice: "Add device",
    newDeviceName: "New device",
    saved: "Device settings saved and applied.",
    deviceCount: "Devices",
    assignedCount: "Assigned paths",
    policyCount: "Policy devices",
    emptyDevices:
      "No named devices yet. Add one manually or create one from recent clients.",
    deviceName: "Device name",
    addresses: "Addresses / CIDR",
    addressCount: "{count} addresses",
    assignedPath: "Resolution path",
    noAssignedPath: "No path binding",
    filteringPolicy: "Filtering policy",
    queryLogPolicy: "Query log policy",
    policyInherit: "Inherit",
    policyEnabled: "Force enabled",
    policyDisabled: "Force disabled",
    childProtection: "Child protection",
    privacyPreset: "Privacy resolution",
    viewQueries: "View queries",
    removeDevice: "Remove device",
    recentClientsTitle: "Recent clients",
    recorderUnavailable:
      "The current runtime config does not enable query_recorder, so clients cannot be discovered automatically. You can still manage devices manually.",
    noRecentClients: "No recent clients.",
    clientQueryCount: "{count} queries",
    nameClient: "Name",
    deviceQueriesTitle: "Device queries",
    selectDeviceHint: "Select a device to inspect recent queries.",
    recordAddressRequired:
      "The device needs at least one non-CIDR address before query records can be loaded.",
    noDeviceQueries: "No query records for this device yet.",
    timeColumn: "Time",
    domainColumn: "Domain",
    qtypeColumn: "Type",
    resultColumn: "Result",
    readFailed: "Failed to read device query data.",
    validationTitle: "Before saving",
    validationCapabilityRequired:
      "This build lacks sequence or client_ip, so device policies cannot be generated.",
    validationNameRequired: "Devices need a name.",
    validationAddressRequired: "Devices need at least one address or CIDR.",
    validationAddressInvalid: "Device addresses must be valid IPs or CIDRs.",
    validationPathRequired: "The selected device path does not exist.",
  ...
  standardOverview: {
    ...
    last24hQps: "Last 24h · {qps} QPS",
    ruleBlocked: "Rule blocking",
    filterDefaultOff: "Filters are off by default",
    ratio: "{value} share",
    responseLatency: "Response latency",
    cpu: "CPU",
    cpuDetail: "OxiDNS process usage",
    memory: "Memory",
    memoryTotal: "{pct} / {total}",
    processRss: "Process RSS",
    enabledState: "Enabled",
    disabledState: "Disabled",
    generalStatsTitle: "General statistics",
    generalStatsDesc:
      "Information density aligned with the AdGuard Home dashboard.",
    upstreamListTitle: "Upstream list",
    upstreamListName: "Upstream",
    upstreamListQueries: "Queries",
    upstreamEmpty: "No upstreams configured.",
    topClientsTitle: "Client ranking",
    topClientsSubtitle: "Clients with the most requests in the last 24 hours",
    topQnamesTitle: "Queried domain ranking",
    topQnamesSubtitle: "Most requested domains in the last 24 hours",
    topBlockedTitle: "Blocked domain ranking",
    topBlockedSubtitle: "Domains matched by standard_ad_rules",
    topClientsEmpty: "No client statistics yet.",
    topQnamesEmpty: "No domain statistics yet.",
    topBlockedEmpty: "No blocked domain statistics yet.",
    queryRecorderDisabled: "query_recorder is not enabled.",
    filterDisabledEmpty: "Filtering is disabled.",
    recentQueriesTitle: "Recent queries",
    recentQueriesDesc:
      "Similar to AdGuard Home Query Log, showing the latest queries for a quick traffic check.",
    recentQueriesEmpty:
      "Query log is empty, or query_recorder is not enabled in this build.",
    tableTime: "Time",
    tableClient: "Client",
    tableQuestion: "Question",
    tableLatency: "Latency",
    summaryDnsQueries: "DNS queries",
    summaryDnsQueriesHint: "Last 24 hours, average {qps} QPS",
    summaryBlocked: "Blocked by filtering rules",
    summaryBlockedHint: "{value} share",
    summaryCacheHits: "Cache hits",
    summaryCacheHitsHint: "From Prometheus metrics or Standard Mode config",
    summaryAvgLatency: "Average processing latency",
    summaryP95: "P95 {value}",
    summaryErrorRate: "Error rate",
    summaryErrorRateHint: "query_recorder timeseries",
    summaryRuntimeVersion: "Runtime version",
  },
  pluginDetail: {
